        ...
        <div class="content">
          <div class="left-side">
            <div class="address details">
              ...
              <br>
              <div class="text-one">Karachi University</div>
            </div>
            <div class="phone details">
              <i class="fas fa-envelop"></i>
              <div class="topic">Email</div>
              <br>
              <div class="text-one">daniyalansari10nov@gmail.com</div>
              <br>
              <i class="fas fa-phone-alt"></i>
              <div class="topic">Phone</div>
              <br>
              <div class="text-one">+92 335 2385051</div>
            </div>
          ...
          <form action="mailto:daniyalansari10nov@gmail.com" enctype="text/plain" method="post">
            <div class="input-box">
