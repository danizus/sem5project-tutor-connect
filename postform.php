...
<center><div class="post_form">
    ...
    <div class="location">
        <h3>Location</h3>
        <div class="lc">
            <?php echo '<input type="text" id="location" name="location" value="'.$f_loca.'" placeholder="e.g: area,City">'; ?>
        </div>
    </div>
    <div class="university">
        ...
        <div class="uni">
            <select name="p_university">
              ...
              <option value="Sir Syed University">Sir Syed University</option>
              <option value="Karachi Univesity">Karachi Univesity</option>
            </select>
        </div>
    </div>
    <div class="deadline">
